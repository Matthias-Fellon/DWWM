...
<table border="1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <?php $imagePath = '../../Public/Images/Users/' . (isset($user['Image_Profil']) ? htmlspecialchars($user['Image_Profil']) : 'defaut.png'); ?>
            ...
            <td><a href="<?= URL ?>update/<?php echo $user['ID_Utilisateur']; ?>">Modifier</a></td>
        </tr>
        <?php endforeach; ?>
    </tbody>
</table>
