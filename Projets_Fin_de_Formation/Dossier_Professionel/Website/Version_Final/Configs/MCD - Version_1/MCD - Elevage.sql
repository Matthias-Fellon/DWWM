...
CREATE TABLE Utilisateur(
	...
	,CONSTRAINT Personne_PK PRIMARY KEY (ID_Utilisateur)
)ENGINE=InnoDB;
...
CREATE TABLE Eleveur(
        ID_Eleveur   	Int  Auto_increment  NOT NULL ,
        Nom_Elevage  	Varchar (50) NOT NULL ,
        Numero_Siret 	Varchar (30) NOT NULL ,
        Description  	Text NOT NULL ,
        ID_Utilisateur  Int NOT NULL
	,CONSTRAINT Eleveur_PK PRIMARY KEY (ID_Eleveur)
)ENGINE=InnoDB;
...
ALTER TABLE Eleveur
	ADD CONSTRAINT Eleveur_Utilisateur0_FK
	FOREIGN KEY (ID_Utilisateur)
	REFERENCES Utilisateur(ID_Utilisateur);

ALTER TABLE Eleveur 
	ADD CONSTRAINT Eleveur_Utilisateur0_AK 
...
ALTER TABLE Chat
	ADD CONSTRAINT Chat_Utilisateur2_FK
	FOREIGN KEY (ID_Utilisateur)
	REFERENCES Utilisateur(ID_Utilisateur);
