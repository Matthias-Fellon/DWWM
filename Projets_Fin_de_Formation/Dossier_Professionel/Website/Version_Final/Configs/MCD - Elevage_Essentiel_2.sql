...
ALTER TABLE Eleveur 
	ADD CONSTRAINT Eleveur_Personne0_AK 
	UNIQUE (ID_Personne);

ALTER TABLE Utilisateur
	ADD CONSTRAINT Utilisateur_Privilege0_FK
	FOREIGN KEY (ID_Privilege)
	REFERENCES Privilege(ID_Privilege);

ALTER TABLE Utilisateur
	ADD CONSTRAINT Utilisateur_Personne1_FK
	FOREIGN KEY (ID_Personne)
	REFERENCES Personne(ID_Personne);

ALTER TABLE Utilisateur 
	ADD CONSTRAINT Utilisateur_Personne0_AK 
	UNIQUE (ID_Personne);
